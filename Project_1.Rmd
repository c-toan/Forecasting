...
ggplot(mean_traffic_by_holiday, aes(x = holiday, y = mean_traffic)) +
  ...
  geom_text(aes(label = round(mean_traffic, 3)), vjust = -0.5) +
  labs(
...
This shows that traffic during the holidays is much less dense, usually people do not work and therefore do not commute and the shops are closed further reducing traffic.
